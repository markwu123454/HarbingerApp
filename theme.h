...
inline QColor windowBg()  { return isDark() ? QColor(0x1e, 0x21, 0x28) : QColor(0xf7, 0xf8, 0xfa); }
...
// ── Borders ───────────────────────────────────────────────────────
inline QColor border()      { return isDark() ? QColor(0x3a, 0x40, 0x4c) : QColor(0xb0, 0xb8, 0xc4); }
